...
\pyfile[firstline=10,lastline=59]{python/causal_attention.py}
...
Sec.~\ref{subsubsec_attn_layer}.  \pyfile[firstline=8, lastline=25]{python/mlp.py}
...
\pyfile[firstline=10, lastline=34]{python/transformer_block.py}
